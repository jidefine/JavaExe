...
public class InkjetPrinter extends Printer {
	...
	public String toString() {
		return "InkjetPrinter [inkReminders=" + inkRemainders + ", modelName=" + modelName + ", manufacturer="
