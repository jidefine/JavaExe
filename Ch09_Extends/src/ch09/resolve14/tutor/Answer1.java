...
public class Answer1 implements IQuestionAnswer {
	...
	public void answer(Scanner sc) {
		...
		ch09.resolve14.tutor.question01.InkjetPrinter ijp = new ch09.resolve14.tutor.question01.InkjetPrinter("HP-264",
				"HP", ch09.resolve14.tutor.question01.P_INTERFACE.USB, 20, 100, 50);
		ijp.print();
		ijp.print();
		ijp.print();
		System.out.println(ijp);

		ch09.resolve14.tutor.question01.LaserPrinter lp = new ch09.resolve14.tutor.question01.LaserPrinter(
				"Sansung-111", "Sansung", ch09.resolve14.tutor.question01.P_INTERFACE.PARALLEL_PORT, 20, 100, 100);
		lp.print();
		lp.print();
		lp.print();
